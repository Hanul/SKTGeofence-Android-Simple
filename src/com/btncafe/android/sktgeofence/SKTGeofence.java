...
public class SKTGeofence {
	...
	/**
	 * Geofence API를 초기화하고, SKT GeoFenceAgent와 연결합니다.
	 * 
	 * @param context
	 * @param tdcProjectKey
	...
	/**
	 * Store Group을 생성하고, storeGroupId를 가져옵니다.
	 * 
	 * @param data
	 * @param idHandler
	 */
	...
	/**
	 * storeGroupId에 해당하는 매장 그룹 정보를 가져옵니다.
	 * 
	 * @param storeGroupId
	 * @param handler
	 */
	...
	/**
	 * data의 storeGroupId에 해당하는 매장 그룹 정보를 수정하고, 수정된 정보를 가져옵니다.
	 * 
	 * @param data
	 * @param handler
	 */
	...
	/**
	 * storeGroupId에 해당하는 매장 그룹 정보를 수정합니다.
	 * 
	 * @param data
	 */
	...
	/**
	 * storeGroupId에 해당하는 매장 그룹 정보를 삭제합니다.
	 * 
	 * @param storeGroupId
	 * @param handler
	 */
	 ...
	 * @param listHandler
	 */
	public void getAllStoreGroupList(ListHandler listHandler) {
	...
	/**
	 * data의 storeId에 해당하는 매장 정보를 수정하고, 수정된 정보를 가져옵니다.
	 * 
	 * @param data
	 * @param handler
	 */
	...
	/**
	 * storeId에 해당하는 매장 정보를 삭제하고, 정보를 가져옵니다.
	 * 
	 * @param storeId
	 * @param handler
	 */
	...
	/**
	 * storeGroupId에 해당하는 매장 그룹 내의 모든 매장 정보를 가져옵니다.
	 * 
	 * @param storeGroupId
	 * @param listHandler
	 */
	public void getStoreListInGroup(int storeGroupId, ListHandler listHandler) {
		listHandlers.add(listHandler);
		agentManager.getWStoreAll(String.valueOf(storeGroupId));
	}

	/**
	 * 이벤트 그룹 정보를 생성하고, eventGroupId를 가져옵니다.
	 * 
	 * @param data
	 * @param idHandler
	 */
	...
	/**
	 * eventGroupId에 해당하는 이벤트 그룹 정보를 가져옵니다.
	 * 
	 * @param eventGroupId
	 * @param handler
	 */
	...
	/**
	 * data의 eventGroupId에 해당하는 이벤트 그룹 정보를 수정하고, 수정된 정보를 가져옵니다.
	 * 
	 * @param data
	 * @param handler
	 */
	...
	/**
	 * eventGroupId에 해당하는 이벤트 그룹 정보를 수정합니다.
	 * 
	 * @param data
	 */
	...
	/**
	 * eventGroupId에 해당하는 이벤트 그룹 정보를 삭제하고, 정보를 가져옵니다.
	 * 
	 * @param eventGroupId
	 * @param handler
	 */
	...
	/**
	 * eventGroupId에 해당하는 이벤트 그룹 정보를 삭제합니다.
	 * 
	 * @param eventGroupId
	 */
	 ...
	 * @param listHandler
	 */
	public void getAllEventGroupList(ListHandler listHandler) {
		listHandlers.add(listHandler);
		agentManager.getWEventGroupAll();
	}

	/**
	 * 이벤트 정보를 생성하고, eventId를 가져옵니다.
	 * 
	 * @param data
	 * @param idHandler
	 */
	...
	/**
	 * eventId에 해당하는 이벤트 정보를 수정하고, 수정된 정보를 가져옵니다.
	 * 
	 * @param data
	 * @param handler
	 */
	...
	/**
	 * eventId에 해당하는 이벤트 정보를 삭제하고, 정보를 가져옵니다.
	 * 
	 * @param eventId
	 * @param handler
	 */
	...
	/**
	 * 특정 매장이 속해있는 모든 이벤트 정보를 가져옵니다.
	 * 
	 * @param storeId
	 * @param listHandler
	 */
	public void getEventListByStore(int storeId, ListHandler listHandler) {
		listHandlers.add(listHandler);
	...
	/**
	 * 특정 펜스 내에 Check In 하였을때 실행할 Handler를 등록합니다. Handler는 Store Id를 가져옵니다.
	 * 
	 * @param checkInHandler
	 */
